...
export default function AirFreightTop() {
  return (
    <div className="site-container mx-auto py-16">
      <div className="relative rounded-2xl overflow-hidden mb-8" style={{minHeight: '14rem'}}>
        ...
        <div className="relative p-6 md:p-10">
          ...
          <p className="mt-3 text-slate-700 max-w-3xl">Swift, reliable air cargo for time-critical shipments, with end-to-end handling and visibility.</p>
        </div>
      </div>
